...
import com.example.tictactoe.databinding.ActivityTicTacToeMainBinding

class TicTacToeMainActivity : AppCompatActivity() {
    private lateinit var  binding: ActivityTicTacToeMainBinding
    private var player = "p1"

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivityTicTacToeMainBinding.inflate(layoutInflater)
